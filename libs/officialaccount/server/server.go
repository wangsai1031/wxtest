...
type Server struct {
	...
	*context.Context
	...
	messageHandler func(*message2.MixMessage) *message.Reply

	RequestRawXMLMsg  []byte
	RequestMsg        *message2.MixMessage
...
func (srv *Server) handleRequest() (reply *message.Reply, err error) {
	...
	mixMessage, success := msg.(*message2.MixMessage)
	if !success {
...
func (srv *Server) parseRequestMessage(rawXMLMsgBytes []byte) (msg *message2.MixMessage, err error) {
	msg = &message2.MixMessage{}
	if !srv.isJSONContent {
...
func (srv *Server) SetMessageHandler(handler func(*message2.MixMessage) *message.Reply) {
